const { gmd, commands, monospace, formatBytes } = require("../luka"),
  fs = require("fs"),
  axios = require("axios"),
...
gmd(
  ...
  async (from, Gifted, conText) => {
    ...
    if (!input) {
      await react("❌");
      return reply(
        `❌ Provide a channel link.\nUsage: *${botPrefix}chjid* https://whatsapp.com/channel/0029VbCpYtZLtOj5L7Q1p`,
      );
    }
